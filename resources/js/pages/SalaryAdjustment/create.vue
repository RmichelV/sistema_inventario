                    ...
                    >
                        <div class="grid gap-6">
                           ...
                           <div class="grid gap-2">
                                ...
                                <select id="salary_adjustment_type" name="salary_adjustment_type" class="px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm" required>
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="amount" type="number" required autofocus :tabindex="1" autocomplete="amount" name="amount" placeholder="Ej. 500.00" step="0.01" min="0"/>
